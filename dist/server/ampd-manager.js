...
exports.AmpdManager = exports.VoteStatusType = void 0;
const events_1 = require("events");
// Vote status types
var VoteStatusType;
(function (VoteStatusType) {
    VoteStatusType["Unsubmit"] = "unsubmit";
    VoteStatusType["Signed"] = "signed";
})(VoteStatusType || (exports.VoteStatusType = VoteStatusType = {}));
class AmpdManager extends events_1.EventEmitter {
    constructor(axelarApiEndpoint, supportedChains = [], ampdAddress) {
        super();
     ...
     */
    processSigningSessions(txResult) {
     ...
     * Process votes and signature submissions
     */
    processVotesAndSignatures(txResult) {
        // Process votes
     ...
     */
    updateChainDataWithPoll(sourceChain, pollId, contractAddress) {
     ...
     */
    updatePollStatusInChainData(pollId, contractAddress, votes) {
        let updated = false;
     ...
     */
    updateSigningStatusInChainData(sessionId, contractAddress) {
        let updated = false;
     ...
     */
    async fetchVoteDetails(txHash, attempt = 1, maxAttempts = 3, delay = 2000) {
        try {
            if (attempt > 1) {
            ...
            if (votes.length > 0) {
                votes.forEach(voteDetail => {
                    if (voteDetail.pollId && voteDetail.contract && voteDetail.votes) {
                        this.updatePollStatusInChainData(voteDetail.pollId, voteDetail.contract, voteDetail.votes);
                    }
                });
            }
...
exports.AmpdManager = AmpdManager;
